...
public class BackupPlayer {
	...
	public BackupPlayer(String playerName, float age, String playerTeam, String playerInternationalStatus) {
		super();
	...
	public BackupPlayer(float age, String playerTeam, String playerInternationalStatus) {
		super();
		this.age = age;
		this.playerTeam = playerTeam;
		this.playerInternationalStatus = playerInternationalStatus;
	...
	public BackupPlayer(int id, String playerName, float age, String playerTeam, String playerInternationalStatus) {
		super();
		Id = id;
		this.playerName = playerName;
		this.age = age;
